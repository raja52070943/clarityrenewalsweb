...
function CobraVisionPlans({ cobraId }) {
    const fetchUrl = `${config.API_URL}/CobraVisionPlans/ByPlanId/${cobraId}`;
    const updateUrl = `${config.API_URL}/CobraVisionPlans`;
    const deleteUrl = `${config.API_URL}/CobraVisionPlans`;
    const addUrl = `${config.API_URL}/CobraVisionPlans`;
    const planName = "Vision"
...
export default CobraVisionPlans;
